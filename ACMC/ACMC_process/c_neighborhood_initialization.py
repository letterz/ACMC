...
from ACMC.ACMC_process.ensemble.a_pre_cluster import pre_cluster_user_vote_process
...
def neighborhood_initialization(data, decision_list, representative, real_labels,users_list,user_locks,min_users_num, max_users_num,max_uncertainty_num,pool,query_times_lock,constraints_num_lock,neighbourhoods_lock,query_times,constraints_num,isUpdate):
    count = query_times
    ...
    neighborhood, users_list, count,constraints_num=pre_cluster_user_vote_process(points_list, users_list, real_labels, min_users_num, max_users_num, count,user_locks,constraints_num,
                                                                                 pool,query_times_lock,constraints_num_lock,neighbourhoods_lock,isUpdate)
