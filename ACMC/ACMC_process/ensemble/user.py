...
def create_some_users(user_num,user_error_rate,initial_confidence,):
    ...
    for i in range(0,user_num):
        ...
        # if newuser.isExpert==True:
        #     newuser.confidence=10
...
#     user_instance = user(user_id=1, username="test", confidence=0.9)
#     try:
#         pickle.dumps(user_instance)
#
#         print("user 对象可以被 pickle 序列化")
#     except pickle.PicklingError:
#         print("user 对象无法被 pickle 序列化")