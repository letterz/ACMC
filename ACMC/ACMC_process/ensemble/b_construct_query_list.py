...
def construct_query_list_for_max_uncertain_xi_list(max_uncertain_xi_list,  N,data):
    ...
    :param n:
    :param N:
    :return: A dictionary of query lists for each point in the maximum uncertainty list.
    """
    query_list_dict={}
    for xi in max_uncertain_xi_list:
        #Construct a query queue for each point in the maximum uncertainty list.
...
def construct_query_list_Q_for_xi(max_uncertain_xi, neighborhood_N, data):
    """
    :param max_uncertain_xi: The instance x∗ in the maximum uncertainty list
    :param neighborhood_N: 
    :param data:
    :return:  Q: [(xi, i_label), (xj, j_label)]
    """
    closest_x_list = []  
